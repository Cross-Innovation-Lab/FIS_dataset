...
## Therapy-FIST Dataset

The Therapy-FIST dataset is available at the following link:
https://drive.google.com/drive/folders/1lxGqRBVydlEUFyWV1PjAwBEGuktjJue4?usp=sharing

The detailed definitions of the FIS subscales can be found in the  PDF file(fis_subscales.pdf).
To load the data of FIS-therpay, you can use the FISdataloader.py file.
